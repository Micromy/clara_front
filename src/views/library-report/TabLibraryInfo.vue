...
.g-path   { grid-template-columns: 72px minmax(230px, 320px) 96px; column-gap: 20px; }
.g-design { grid-template-columns: 72px 150px 150px 130px 90px; column-gap: 20px; }

/* Every table's box shrinks to its own content width — no table stretches to
   match another; each sizes independently by its own data. */
